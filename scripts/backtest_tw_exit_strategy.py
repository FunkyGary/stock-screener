...
from scripts.backtest_tw_strategy import (  # noqa: E402
    ACTIVE_SLOT,
    BENCHMARK,
    DEFAULT_WEIGHTS,
    INITIAL_CAPITAL,
...
def _preset_cases() -> list[tuple[str, str, str]]:
    return [
        ("tw_bear_2020", "2020-01-02", "2020-12-31"),
        ("tw_choppy_2021", "2021-01-04", "2021-12-30"),
        ("tw_bull_2025_2026", "2025-01-02", "2026-05-28"),
    ]
...
def main() -> None:
    ...
    parser.add_argument("--preset", choices=["all"], help="run the three TW market cases")
